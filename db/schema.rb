...
ActiveRecord::Schema.define(version: 20160114162945) do
  ...
  add_index "travellers", ["provider"], name: "index_travellers_on_provider", using: :btree
  add_index "travellers", ["reset_password_token"], name: "index_travellers_on_reset_password_token", unique: true, using: :btree
  add_index "travellers", ["uid"], name: "index_travellers_on_uid", using: :btree
